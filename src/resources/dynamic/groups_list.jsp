...
<html>
    ...
    <body>
        <div class="container">
            <h3><img height="50" width="55" src="<c:url value="/static/logo.png"/>"/><a href="/groups_list">Groups List</a></h3>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="groupList" class="nav navbar-nav">
                            ...
                            <li><button type="button" id="contact_list" class="btn btn-default navbar-btn">Contact List</button></li>
                        </ul>
                        <form class="navbar-form navbar-left" role="search" action="/group/search" method="post">
            ...
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    <c:forEach var="i" begin="1" end="${pages}">
                        <li><a href="/groups_list/?page=<c:out value="${i - 1}"/>"><c:out value="${i}"/></a></li>
                    </c:forEach>
                </ul>
            </nav>
        </div>
